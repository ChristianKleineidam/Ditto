...
CString CHotKey::GetVirKeyName(unsigned int virtualKey)
{
       ...
       {
       case VK_VOLUME_MUTE:
               return _T("Volume Mute");
       case VK_VOLUME_DOWN:
               return _T("Volume Down");
       case VK_VOLUME_UP:
               return _T("Volume Up");
       case VK_MEDIA_NEXT_TRACK:
               return _T("Media Next");
       case VK_MEDIA_PREV_TRACK:
               return _T("Media Prev");
       case VK_MEDIA_STOP:
               return _T("Media Stop");
       case VK_MEDIA_PLAY_PAUSE:
               return _T("Media Play/Pause");
       case VK_BROWSER_BACK:
               return _T("Browser Back");
       case VK_BROWSER_FORWARD:
               return _T("Browser Forward");
       case VK_BROWSER_REFRESH:
               return _T("Browser Refresh");
       case VK_BROWSER_STOP:
               return _T("Browser Stop");
       case VK_BROWSER_SEARCH:
               return _T("Browser Search");
       case VK_BROWSER_FAVORITES:
               return _T("Browser Favorites");
       case VK_BROWSER_HOME:
               return _T("Browser Home");
       case VK_LAUNCH_MAIL:
               return _T("Launch Mail");
       case VK_LAUNCH_MEDIA_SELECT:
               return _T("Launch Media");
       case VK_LAUNCH_APP1:
               return _T("Launch App1");
       case VK_LAUNCH_APP2:
               return _T("Launch App2");
       }
